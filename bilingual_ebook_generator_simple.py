...
class BilingualEbookGeneratorSimple:
    """双语电子书生成器（简化版）"""
...
def main():
    """主函数"""
    print("🚀 Paul Graham Essays - 双语电子书生成器（简化版）")
    print("=" * 50)
    
    generator = BilingualEbookGeneratorSimple()
    ...
    formats = format_map.get(choice, ['epub', 'html'])
